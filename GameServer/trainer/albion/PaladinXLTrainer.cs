...
namespace DOL.GS.Trainer
{
	...
	/// PaladinXL Trainer
	/// </summary>
	[NPCGuildScript("PaladinXL Trainer", eRealm.Albion)]		// this attribute instructs DOL to use this script for all "Paladin Trainer" NPC's in Albion (multiple guilds are possible for one script)
	public class PaladinXLTrainer : GameTrainer
	{
		public override eCharacterClass TrainedClass
		{
			get { return eCharacterClass.PaladinXL; }
		}
			...
			//{
				switch (text)
				{
					case "join the Church of Albion":
						...
						break;
					case "slashing":
						PromotePlayer(player, (int)eCharacterClass.PaladinXL, "Here is your Sword of the Initiate. Welcome to the Church of Albion.", null);
						player.ReceiveItem(this,WEAPON_ID1);
						break;
					case "crushing":
						PromotePlayer(player, (int)eCharacterClass.PaladinXL, "Here is your Mace of the Initiate. Welcome to the Church of Albion.", null);
						player.ReceiveItem(this,WEAPON_ID2);
						break;
					case "thrusting":
						PromotePlayer(player, (int)eCharacterClass.PaladinXL, "Here is your Rapier of the Initiate. Welcome to the Church of Albion.", null);
						player.ReceiveItem(this,WEAPON_ID3);
						break;
					case "two handed":
						PromotePlayer(player, (int)eCharacterClass.PaladinXL, "Here is your Great Sword of the Initiate. Welcome to the Church of Albion.", null);
